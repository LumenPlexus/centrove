...
/* v35 · 缓存版本 v46：新增四大功能（一键成长报告导出、过去日期补卡、番茄钟→习惯联动计数、"期末冲刺"倒数预设）+ 数据备份全面升级——导出/导入/清空改为「全量快照」，随笔/心情/祝福/模板/清单/毕业准备进度/成就/首次使用日等此前遗漏的数据键一并纳入，换机恢复不再丢记录（兑现"只存你手·可备份"承诺）。 */
const CACHE = 'pingwanxiang-v46';
